...
#ifndef __objc_gnu2next_h_SWARM_INCLUDE
#define __objc_gnu2next_h_SWARM_INCLUDE
...
#define get_imp(CLASSPOINTER, SEL) \
    (CACHE_BUCKET_IMP(class_getInstanceMethod(CLASSPOINTER, SEL)))
...
/* Additional datatypes not defined in the objc runtime headers */
#define _C_LNG_LNG	'q'
#define _C_ULNG_LNG	'Q'
#define _C_LNG_DBL	'X'
#define _C_ATOM 	'%'

/* protocol method modifiers */
#define _C_CONST	'r'
#define _C_IN 		'n'
#define _C_INOUT	'N'
#define _C_OUT		'o'
...
#endif /* __objc_gnu2next_h_SWARM_INCLUDE */
